...
_AGENTUPDATE_POSE = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='x', full_name='colav.AgentUpdate.Pose.x', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='y', full_name='colav.AgentUpdate.Pose.y', index=1,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='z', full_name='colav.AgentUpdate.Pose.z', index=2,
